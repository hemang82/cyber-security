...
export default function InventoryDetailsComponent({ InventoryData }: any) {
    ...
    const handlePdfDownload = async () => {
        ...
        try {
            ...
            // Pixel ratio 4 gives very high resolution (approx 384 DPI on standard screens)
            const dataUrl = await toPng(element, {
                cacheBust: true,
                backgroundColor: "#ffffff",
                pixelRatio: 4,
            ...
            // Ratio to fit image width to A4 width
            const ratio = pdfWidth / imgWidth;

            // Height of one A4 page in terms of source image pixels
            const pageHeightInImagePixels = pdfHeight / ratio;
            ...
            // Max height needed is one page worth of pixels
            ...
            while (position < imgHeight) {
                ...
                if (ctx) {
                    ...
                    const pageDataUrl = canvas.toDataURL('image/png', 1.0); // 1.0 quality

                    // Destination height on PDF document
                    const destHeight = sliceHeight * ratio;

                    // Add to PDF (removed 'FAST' for better quality default)
                    pdf.addImage(pageDataUrl, "PNG", 0, 0, pdfWidth, destHeight, undefined, 'SLOW');
                }
    ...
    return (<>
        <div ref={pageRef} className="p-3">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-1">
                ...
                {/* Performance */}
                <div id="pdf-section-performance" style={{ marginTop: pdfMargins.performance }}>
                ...
                <div id="pdf-section-security" style={{ marginTop: pdfMargins.security }}>
