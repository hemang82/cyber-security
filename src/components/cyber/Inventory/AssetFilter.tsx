...
export default function AssetFilter({ resInventoryList }: { resInventoryList: any }) {
    ...
    const handleAssetChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        // Use transition to keep the UI interactive and avoid full page flickering
        startTransition(() => {
    ...
    return (
        <div className="w-full max-w-xs" onMouseEnter={handleMouseEnter}>
            <div className="relative">
                ...
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-400">
                    {isPending ? (
                        <AiOutlineLoading3Quarters className="h-4 w-4 animate-spin text-brand-500" />
                    ) : (
