    ...
    >
      ...
      {options.map((option) => (
        <option
          ...
          className={` ${option?.status == "pending" ? "text-red-300" : ""} ${option?.status == "verified" ? "text-green-700" : ""}
      dark:bg-gray-900 dark:text-gray-400 cursor-pointer text-gray-800 
    `}
        >
          {option.label}
