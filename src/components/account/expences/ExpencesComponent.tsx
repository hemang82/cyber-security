...
export default function ExpencesComponent({ expenceList }: any) {
  ...
  console.log('expenceListexpenceList', expenceList);

  return (
    <>
      <DynamicTable columns={columns} data={expenceList?.length > 0 ? expenceList : []} />
      {/* PAGINATION */}
      <Pagination
        currentPage={page}
        perPage={perPage}
        totalCount={expenceList}
